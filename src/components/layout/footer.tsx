  ...
  return (
    <footer className="flex  flex-col items-center bg-primary md:gap-6 text-white  w-full md:p-4">
      <div className=" flex flex-col items-center md:gap-2">
        <Button className="rounded-full" size="icon" variant={"link"} asChild>
          <a href={INSTAGRAM_URL} target="_blank">
            <Instagram className="stroke-white hover:stroke-white/30" />
          </a>
        </Button>
        <a
          href={ENDERECO_URL}
          className="hidden md:inline hover:text-white/30"
          target="_blank"
        >
